...
const BettingTable = () => {
  ...
  return (
    <div className="">
      <div className="rounded-[25px]  mb-5   overflow-hidden">
        <div className="flex p-4  bg-gradient-to-r from-[#f06514] to-[#e53e54] justify-between items-center text-white overflow-hidden">
          ...
          <div className="text-[]">
            ...
            <div className="flex items-center gap-1">
              ...
              <strong className="text-[12px]" >203392.21 BDT
              </strong>
            </div>
          </div>
          <div className="text-[]">
            ...
            <div className="flex items-center gap-1">
              ...
              <strong className="text-[12px]" >147139.11 BDT
              </strong>
            </div>
          </div>
        </div>
        <div className=" bg-[#181B39] p-3 pb-4">
          <table className="table-auto w-full text-left text-white">
            <thead>
              <tr className="">
                <th className="px-4 text-[14px] text-black-muted py-2">USERNAME</th>
                <th className="px-4 text-[14px] text-black-muted py-2">ODDS</th>
                <th className="px-4 text-[14px] text-black-muted py-2">BET</th>
                <th className="px-4 text-[14px] text-black-muted py-2">WIN</th>
              </tr>
            </thead>
            <tbody>
              {bettingData?.map((row, index) => (
                ...
                >
                  <td className="px-4 py-2 text-[12px]">{row.username}</td>
                  <td className="px-4 py-2  text-[12px]">{row.odds}</td>
                  <td className="px-4 py-2 text-red-500  text-[12px]">{row.bet}</td>
                  <td
